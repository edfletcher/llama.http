...
This fork implements a simple HTTP API in [examples/simple-http](examples/simple-http/).

See [the README there](examples/simple-http/README.md) for full information.
